...
const Features = () => {
  ...
  useGSAP(() => {
    ...
    animateWithGsap(".g_text", { y: 0, opacity: 1, ease: "power2.inOut", duration: 1.5 });
  }, []);
  return (
      ...
      <div className="screen-max-width">
        ...
        <div className="flex flex-col items-center overflow-hidden justify-center">
          <div className="mt-32 mb-24 pl-24">
            ...
            <h2 className="text-5xl lg:text-7xl font-semibold">Forged in titatnium</h2>
          </div>
          <div className="flex-center flex-col sm:px-10">
            ...
            <div className="flex flex-col w-full relative">
              ...
              <div className="feature-text-container">
                ...
                <div className="flex-1 flex-center">
                  <p className="feature-text g_text">
                    TItanium has one of the best strengths-to-weight ratio of any metal, making our{" "}
